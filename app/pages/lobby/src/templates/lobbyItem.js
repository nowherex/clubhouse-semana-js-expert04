...
function createFeaturedSpeakersTemplate(featuredAttendee) {
    if(!featuredAttendee.length) return '';

    const attendees = featuredAttendee.map(attendee => {
        return `
    ...
    <div class="cards__card">
      ...
      <div class="cards__card__info">
        ...
        <div class="cards__card__info__speakers">
          <ul>
          ${createFeaturedSpeakersTemplate(room.featuredAttendee)}
